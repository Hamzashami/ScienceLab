...
public class Main2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Item item1 = new Item(1,"الأجهزة الميكانيكية","",1,R.drawable.ic_mec);
        Item item2 = new Item(2,"الأجهزة الكهربائية","",2,R.drawable.ic_electr);
        Item item3 = new Item(3,"كهرباء ساكنة","",3,R.drawable.ic_static);
        Item item4 = new Item(4,"أجهزة مغناطيسية","",4,R.drawable.ic_magnetic);
        Item item5 = new Item(5,"أجهزة حرارة","",5,R.drawable.temp_1);
    ...
    private void initViews() {
        ...
        title_toolbar.setText("Lab Guide");
        title_toolbar.setTextColor(Color.WHITE);
