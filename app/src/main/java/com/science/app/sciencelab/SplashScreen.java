        ...
        if (isFirst) {
            ...
            myDbHelper.addItem("الميكروميتر",
                    "هو عبارة عن جهاز مصمم لقياس البعد بين نقطتين للعديد من الأسطح ذات الأبعاد والأشكال المختلفة (كالطول والعرض والسمك والقطر والعمق) والتى تتطلب دقة عالية في القياس .\n" +
                            "يتكون جهاز ميكرومتر القياس الخارجي من" +
                            "\n" +
                            "جزئين أساسين:\n" +
                            "1)الجزء الثابت : ويحتوي على إطار أو هيكل الجهاز (Frame)على شكل حرف (U) لحمل بقية مكونات الجهاز الثابتة والمتحركة منها.\n" +
                            "2)الجزء المتحرك : الجزء الأساسي المتحرك هو جلبة القياس (Sleeve) التي إذا قمنا بتحريكها حركة دورانية عن طريق المسمار الجاس (Ratchet Knob)  فيتحرك عمود القياس لتثبيت الشيء المراد قياسه.\n"
                    , R.drawable.photo5, 1);
            ...
            myDbHelper.addItem("المسعر الحراري",
                    "جهاز يستخدم لتقدير وقياس كمية الحرارة المصاحبة للتفاعل الكيميائي  .\n" +
                            "\n" +
